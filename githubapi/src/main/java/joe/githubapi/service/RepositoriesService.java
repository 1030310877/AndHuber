...
public interface RepositoriesService {
    ...
    Observable<ReadMeInfo> getReadMe(@Path("owner") String owner, @Path("repo") String repo);

    @GET("/repos/{owner}/{repo}/readme")
    Observable<ResponseBody> getReadMeWithHeader(@Header("Accept") String accept, @Path("owner") String owner, @Path("repo") String repo);
}
